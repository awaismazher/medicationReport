...
class MedicationReport extends Component {
  ...
  componentDidMount() {
      ...
      res => {
        const reportId =
          this.props.location && this.props.location.state && this.props.location.state.reportId
            ...
            : null;
        const finalData =
          this.props.location && this.props.location.state && this.props.location.state.finalData
    ...
    if (this.props.location.state) {
      ...
      if (this.props.location && this.props.location.state && this.props.location.state.reportId) {
        GetSingleReport(this.props.location.state.reportId, res => {
          ...
          this.setState(
            ...
            () => {
              ...
              this.setState({ assignedToName: res.assignedToName });
              this.setState({ assignedToTypeId: res.assignedToTypeId });
              this.setState({
                assignedToRole:
              ...
              this.setState({ timeOfReportCreation: moment(res.createdAt).format(YY_MM_DD) });
              this.setState({ timeOfReportUpdate: moment(res.updatedAt).format(YY_MM_DD) });
  ...
  render() {
    ...
    if (
      ...
      suggestedMedication.medications[0].medicineId &&
      suggestedMedication.medications[0].medicineId !== null
    ) {
